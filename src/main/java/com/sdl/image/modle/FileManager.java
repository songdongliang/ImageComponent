package com.sdl.image.modle;

import com.sdl.image.config.FileManageConfig;
import org.csource.common.NameValuePair;
import org.csource.fastdfs.*;

import java.io.File;

public class FileManager implements FileManageConfig {
    ...
    static {
        try {
            ...
            ClientGlobal.initByProperties(fdfsClientConfigFilePath);
